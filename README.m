...
Amoné copies the Account_Record string and heads over to  [https://silversixpence.io/master:/main](https://merkle.silversixpence.io/lostleolotus-main:/) where she pastes the string into the form and verifies the hash that SixpenceCoin displayed in her profile. The web application builds her unique tree path with all the hashes to the Root. Amoné is now ready to do a Merkle-Proof.
